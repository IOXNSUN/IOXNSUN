# Привет! 👋 Я [IOXNSUN](https://github.com/IOXNSUN)
...
## 📈 Цель
- Переход на позиции **Middle+ / Lead инженера сопровождения или интегратора**  
- Продолжение работы с продакшен-сервисами, CI/CD и инфраструктурой  
- Автоматизация и интеграция бизнес-процессов для e-commerce и банковских сервисов  
